...
from nprba.utils.joints import JointType
...
def central_second_moments_to_diag_inertia_matrix(L):
    ...
    jyy = L[0,0] + L[2,0]
    jzz = L[0,0] + L[1,0]
    return jnp.diag(jnp.array([jxx, jyy, jzz]))
